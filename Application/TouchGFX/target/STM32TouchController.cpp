				...
				if(HAL_I2C_Mem_Read( &hi2c3, 0x70, 0x02, I2C_MEMADD_SIZE_8BIT, &Buf[0], 5, 10 ) == HAL_OK)
				{
					...
					if( ID == 0 )
					{
						if( ( event == 0x00 ) || ( event == 0x02 ) )
						{
							...
							x = (sx * 800) / 1272;   //sx = 1272  => x = 480
							y = (sy * 480) / 767;    //sy = 767   => y = 272
...
//					{
//						wakeUp_flag = 1;
//						HAL_I2C_Mem_Read( &hi2c3, 0x82, 0x30, I2C_MEMADD_SIZE_8BIT, &Buf[0], 10, 10 );
//					}
				}
				else
				{
//					HAL_I2C_Mem_Read( &hi2c3, 0x82, 0x31, I2C_MEMADD_SIZE_8BIT, &Buf[0], 10, 10 );
